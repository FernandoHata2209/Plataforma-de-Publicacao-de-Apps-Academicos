...
<head>
    ...
    <title>Plataforma de Publicacoes de Apps Academicos</title>
...
<body>
    ...
    <div class="container-header-menu">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('publicar.store') }}" id="form-publish" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="loginEmail" class="form-label">Imagem / Video do Projeto</label>
        ...
        @if ($usuarios->isEmpty() && $aplicativos->isEmpty())
...
@else
    ...
    @if ($mostrarUsuarios)
        <!-- Seção para mostrar resultados de usuários -->
        @foreach ($usuarios as $usuario)
            <div class="card text-center mt-3 mb-3">
                ...
                <div class="card-body">
                    <h5 class="card-title">{{ $usuario->nome }}
                    ...
                    @endif
                    <a href="{{ route('user.perfil', $usuario->id) }}" class="btn btn-primary">Ir ao Perfil</a>
                </div>
        ...
        <!-- Seção para mostrar resultados de aplicativos -->
        @if ($mostrarAplicativos)
        @foreach ($aplicativos as $aplicativo)
            @if ($aplicativo->status === 'Aprovado')
                <div class="card mb-3 mt-3">
                    <img src="{{ asset('imagesProject//' . $aplicativo->media) }}" class="card-img-top" alt="...">
                    <div class="card-body">
