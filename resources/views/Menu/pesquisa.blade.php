...
<div class="container-header-menu">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('menu.pesquisa') }}" method="GET">
                        @csrf
                        <div class="mb-3">
                            <input type="text" class="form-control" id="loginEmail" required name="termo_pesquisa">
                        </div>
    ...
    @if($usuarios->isEmpty() && $aplicativos->isEmpty())
        <div class="none-publish">
            <h3 id="title-none-publish">Nenhum resultado encontrado para "{{ $termoPesquisa }}".</h3>
        </div>
    @else
    <div class="none-publish">
        <h3 id="title-none-publish">Resultados sobre: {{ $termoPesquisa }}.</h3>
    </div>
            ...
            @foreach ($usuarios as $usuario)
                ...
                <div class="content-publish">
                    <div id="header-publish">
                        ...
                        <!-- Outras informações do usuário aqui -->
                    </div>
                </div>
            @endforeach
