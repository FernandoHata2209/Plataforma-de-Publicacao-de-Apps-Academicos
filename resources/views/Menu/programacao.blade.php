...
<head>
    ...
    <title>Programação - Plataforma de Publicação de Apps Acadêmicos</title>
...
<body>
    <div class="container-header-menu">
        ...
        @foreach ($aplicativos as $aplicativo)
                @if ($aplicativo->tipo === 'Programacao')
        ...
        <div class="container-project-publish">
                ...
                <div class="none-publish">
                    <h3 id="title-none-publish">Nenhuma aplicativo para aprovar no momento</h3>
                </div>
            @endif
        @endforeach
        </div>
